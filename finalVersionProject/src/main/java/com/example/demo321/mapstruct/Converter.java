...
public class Converter {
    ...
    public FilmDTO toDTO(Film film) {
        ...
        dto.setYearFrom(film.getYearFrom());
        dto.setRatingKinopoiskFrom(film.getRatingKinopoiskFrom());
        dto.setYearTo(film.getYearTo());
        dto.setRatingKinopoiskTo(film.getRatingKinopoiskTo());
    ...
    public Film toEntity(PostFilmDTO postFilmDTO) {
        ...
        film.setRatingKinopoiskTo(postFilmDTO.getRatingKinopoiskTo());
        film.setYearTo(postFilmDTO.getYearTo());
        film.setYearFrom(postFilmDTO.getYearFrom());
        film.setRatingKinopoiskFrom(postFilmDTO.getRatingKinopoiskFrom());
        return film;
    }
